(function ($) {
    ...
    function initCalendarMenu() {
        var $monthMenu = $('.content-wrapper').find('.month-list');
        var $locationMenu = $('.content-wrapper').find('.locations-list');
        var $btnMonth = $('.content-wrapper').find('.link-calendar');
        var $btnLocation = $('.content-wrapper').find('.link-location');
        initList($btnMonth, $monthMenu, $locationMenu);
        initList($btnLocation, $locationMenu, $monthMenu);
        initColumDivision($monthMenu);
        initColumDivision($locationMenu);
    }


    function initColumDivision($menu) {
        //var $menu = $('.content-wrapper').find(listClass);
    ...
    function initList($btn, $nav, $navSecondMenu) {
        var $content = $('.content-wrapper'),
        //$btn = $content.find('.link-calendar'),
        //$nav = $content.find(listClass),
          animationSpeed = 200;
        ...
        $btn.on('click touch', function (e) {
            ...
            $btn.siblings(".link.active").removeClass('active');
        });
    }
