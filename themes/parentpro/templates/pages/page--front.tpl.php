...
<script type="text/javascript">
  ...
  document.write('<iframe src="https://3002430.fls.doubleclick.net/activityi;src=3002430;type=oklah0;cat=osdh-0;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
</script>
<noscript>
  <iframe src="https://3002430.fls.doubleclick.net/activityi;src=3002430;type=oklah0;cat=osdh-0;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
</noscript>
      ...
      <div class="cols cols-two style-a">
        <?php if ($page['column_left']): ?>
          <div class="col col-1">
            <div class="col-hd">
              <div class="col-inner">
                <h3><?php print t('Find Services'); ?></h3>
              </div>
            </div>
            <div class="col-bd">
              <div class="col-inner">
                <h5><?php print t('Select a region to find services available in your area.'); ?></h5>
