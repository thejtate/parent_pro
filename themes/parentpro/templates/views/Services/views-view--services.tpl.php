...
$services_tid = isset($view->args[0]) ? $view->args[0] : NULL;
?>

<div class="map-wrapper map-wrapper-state <?php print $classes; ?>">
  ...
  <?php if ($rows): ?>
    <div class="map">
      ...
      <map name="map">
        <area <?php if ($services_tid == 5) {print 'class="active"';}?> data-for-desc="0" href="#" alt="" data-maphilight='{"fillColor":"4d8070"}'
              shape="poly"
        ...
        <area <?php if ($services_tid == 14) {print 'class="active"';}?> data-for-desc="1" href="#" alt="" data-maphilight='{"fillColor":"68ad45"}' shape="poly"
        ...
        <area <?php if ($services_tid == 10) {print 'class="active"';}?> data-for-desc="2" href="#" alt="" data-maphilight='{"fillColor":"ad4556"}' shape="poly"
        ...
        <area <?php if ($services_tid == 12) {print 'class="active"';}?> data-for-desc="3" href="#" alt="" data-maphilight='{"fillColor":"ad6c2b"}' shape="poly"
        ...
        <area <?php if ($services_tid == 11) {print 'class="active"';}?> data-for-desc="4" href="#" alt="" data-maphilight='{"fillColor":"923f8c"}' shape="poly"
        ...
        <area <?php if ($services_tid == 9) {print 'class="active"';}?> data-for-desc="5" href="#" alt="" data-maphilight='{"fillColor":"7c7cb3"}' shape="poly"
